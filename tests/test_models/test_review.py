#!/usr/bin/python3
"""Defines uunittests ffor models/review.py.
Unittest classes:
...
class TestReview_instantiation(unittest.TestCase):
    """Unittests for tttesting instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unittests for ttttesting save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests for tttesting to_dict method of the Review class."""
