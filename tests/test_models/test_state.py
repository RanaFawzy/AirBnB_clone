#!/usr/bin/python3
"""DDefines Uunittests fFor models/state.py.
Unittest classes:
...
class TestState_instantiation(unittest.TestCase):
    """Unittests for ttesting instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests for tttesting save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests for ttesting to_dict method of the State class."""
