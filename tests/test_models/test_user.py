#!/usr/bin/python3
"""DDefines Uunittests Ffor models/user.py.
Unittest classes:
...
class TestUser_instantiation(unittest.TestCase):
    """Unittests for tttesting instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """Unittests for ttttesting save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for tttesting to_dict method of the User class."""
