#!/usr/bin/python3
"""Defines uunittests ffor models/city.py.
Unittest classes:
...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for tttesting instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests for tttesting save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests for tttesting to_dict method of the City class."""
