#!/usr/bin/python3
"""Defines uunittests ffor models/place.py.
Unittest classes:
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests for tttesting instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests for tttesting save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for tttesting to_dict method of the Place class."""
